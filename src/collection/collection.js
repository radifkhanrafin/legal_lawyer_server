...
const blogsCollection = new mongoose.model("blogs", blogDataModel);

const awarenessCollection = new mongoose.model("awareness", awarenessDataModel);

module.exports = { chatCollection, messageCollection, lawyerCollection, practiceCollection, userCollection, paymentCollection,clientCollection ,caseCollection ,ourReviewsCollection ,awarenessCollection,blogsCollection}